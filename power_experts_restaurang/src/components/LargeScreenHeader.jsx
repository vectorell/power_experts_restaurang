...
const LargeScreenHeader = () => {
  ...
  // lyssna på när selectedfooditems uppdateras:
  useEffect(() => {
  ...
  return (
    <div className="header-desktop">
      <img
        src="src\components\images\logo-no-background 1.png"
        alt="Företagslogga Feast & Fare"
        onClick={onClickHome}
      ...
      <div>
        <FontAwesomeIcon
          ...
          className={areItemsInCart ? "cart cart-desktop link fa-lg change-color " : "cart cart-desktop link fa-lg"}
          onClick={onClickCart}
          onKeyDown={onKeyDownCart}
          aria-label="Varukorg"
        />
       <div>{areItemsInCart ? <TextForCartShopping /> : null}</div> 
      </div>
    </div>
  );
};
